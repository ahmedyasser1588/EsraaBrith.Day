...
x = setInterval(function() {
  ...
  let w = (c.width = window.innerWidth),
    ...
    opts = {
      ...
      charSize: 40, // Increased font size
      charSpacing: 50,
      lineHeight: 80,
  ...
  function anim() {
    ...
    if (done) {
      ...
      // Open a new page when the animation finishes
      window.location.href = 'newpage.html'; // Replace 'newpage.html' with your desired URL
    }
  }
...
// Remove modal when clicking the box
...
closeModalBtn.addEventListener('click', () => {
  modalOverlay.style.visibility = 'hidden'; // Hide the modal overlay
  modalOverlay.style.opacity = '0'; // Smoothly fade out the modal
});
